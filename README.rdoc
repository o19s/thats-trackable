...
# To run migrations run `heroku run rake db:migrate --app stormy-fjord-4119-staging`
...
# Using Sparkline from https://github.com/cubus/jquery-sparkline-rails that is forked from original project bc updated for Rails 4.