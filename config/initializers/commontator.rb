...
Commontator.configure do |config|
  ...
  config.current_user_proc = lambda { |controller| controller.current_runner }
  ...
  # This is specific to Runtracker to use the facebook avatar instead of gravatar.
  config.user_avatar_proc = lambda { |user, view|
                                     view.image_tag(
                                       user.facebook_user.avatar_url, class: 'avatar',:alt => user.name
                                       ) unless user.facebook_user.nil?
                                    }
